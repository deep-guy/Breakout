...
def gameo():
    global l,l1,l2,l3,tb,l21,l22,l23,l24,l25,l26,l27
    def check(q):
    ...
    if(((check(l)+check(l1)+check(l2)+check(l3))==0 and tb==[0,0]) or (check(l21)+check(l22)+check(l23)+check(l24)+check(l25)+check(l26)+check(l27))==0):
                global bge
